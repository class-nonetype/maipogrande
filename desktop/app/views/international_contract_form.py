...
class InternationalContractFormView(QtWidgets.QMainWindow):
    _gripSize = 1
...
"")
        ...
        self.labelClosingDate = QtWidgets.QLabel(self.groupBoxForm)
        self.labelClosingDate.setStyleSheet("QLabel {\n"
"    font: 25 11pt \"Microsoft YaHei UI Light\";\n"
"}")
        self.labelClosingDate.setObjectName("labelClosingDate")
        self.gridLayout_2.addWidget(self.labelClosingDate, 0, 0, 1, 1)
        self.comboBoxValidity = QtWidgets.QComboBox(self.groupBoxForm)
        self.comboBoxValidity.setStyleSheet("QComboBox {\n"
"    font: 25 11pt \"Microsoft YaHei UI Light\";\n"
"}")
        self.comboBoxValidity.setObjectName("comboBoxValidity")
        self.comboBoxValidity.addItem("")
        self.comboBoxValidity.addItem("")
        self.gridLayout_2.addWidget(self.comboBoxValidity, 2, 1, 1, 1)
        self.labelValidity = QtWidgets.QLabel(self.groupBoxForm)
        self.labelValidity.setStyleSheet("QLabel {\n"
"    font: 25 11pt \"Microsoft YaHei UI Light\";\n"
"}")
        self.labelValidity.setObjectName("labelValidity")
        self.gridLayout_2.addWidget(self.labelValidity, 2, 0, 1, 1)
        self.dateEdit = QtWidgets.QDateEdit(self.groupBoxForm)
        self.dateEdit.setStyleSheet("QDateEdit {\n"
"    font: 25 11pt \"Microsoft YaHei UI Light\";\n"
"}")
        self.dateEdit.setDateTime(QtCore.QDateTime(QtCore.QDate(2023, 1, 1), QtCore.QTime(3, 0, 0)))
...
"")
        ...
        self.gridLayout_2.addWidget(self.pushButtonPost, 4, 0, 1, 1)
    ...
    def retranslateUi(self):
        ...
        self.labelClosingDate.setText(_translate("MainWindow", "Fecha de termino"))
        self.comboBoxValidity.setItemText(0, _translate("MainWindow", "SI"))
        self.comboBoxValidity.setItemText(1, _translate("MainWindow", "NO"))
        self.labelValidity.setText(_translate("MainWindow", "Vigente"))
