...
urlpatterns = [
	...
	###################################################################
	path('transaction/<int:id_bank_account>/<int:amount>/<int:id_product>/<int:quantity>/<int:id_producer>/<int:id_client>/<int:price>/', views.generate_sales_transaction, name = 'generate_sales_transaction'),
	...
	path('client/request/status/<int:id_client>/', views.client_requests_status, name = 'client_requests_status'),


	###################################################################
	#	URL de recarga de creditos virtuales						  #
	###################################################################
	path('recharge/<int:id_bank>/<int:recharge_amount>/', views.recharge_amount, name = 'recharge_amount'),
