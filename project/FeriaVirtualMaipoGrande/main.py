...
def print_logo_desktop_app():
    print(f'''{logo_desktop}\n''')
...
def install_requirements():
    ...
    try:
        for requirement in requirements:
            return os.system(
                    f'''pip3 install "{requirement}" && python3 -m pip3 install --upgrade pip'''
            )
...
def start_django_web():
    ...
    try:
        ...
        return os.system(
            f'''python3 "{Environment.attr['path']['web.manage']}" runserver 0:8000'''
        )
...
def make_migrations_django_web():
    ...
    try:
        ...
        return os.system(
            f'''python3 "{Environment.attr['path']['web.manage']}" makemigrations maipogrande'''
        )
...
def migrate_django_web():
    ...
    try:
        ...
        return os.system(
            f'''python3 "{Environment.attr['path']['web.manage']}" migrate'''
        )
...
def create_user_admin_django_web():
    ...
    try:
        ...
        return os.system(
            f'''python3 "{Environment.attr['path']['web.manage']}" createsuperuser'''
        )
...
command = {
    ...
    'print_logo_test' : print_logo_test,
    'print_logo_desktop_app' : print_logo_desktop_app,
